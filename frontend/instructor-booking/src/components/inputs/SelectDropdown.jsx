...
const SelectDropdown = ({ options, value, onChange, placeholder }) => {
  ...
  return (
    <div className="relative w-full">
      {/* Dropdwon Button */}
      <button onClick={() => setIsIsOpen(!isOpen)} className="w-full text-sm text-black outline-none bg-white border border-slate-100 px-2.5 py-3 rounded-md mt-2 flex justify-between items-center">
        {value
